#!/usr/bin/env python3
"""Emit shell exports for the locked PARH-OSSM profile.

Use with:

    eval "$(python setup/locked_parh_profile.py)"

This script pins high-risk experimental switches for reproducible PARH-OSSM
runs. It does not tune numeric hyperparameters.
"""
...
LOCKED_ENV = OrderedDict(
    [
        ...
        ("RESPYRE_PARH_ENABLE_COMPAT_COUPLED_Q", "0"),
...
def main() -> int:
    ...
    if args.json:
        ...
        return 0
    print("# PARH-OSSM locked profile")
